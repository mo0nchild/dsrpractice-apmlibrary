...
{
    public sealed class CreateBookValidation : AbstractValidator<CreateBookCommand>
    {
        public CreateBookValidation() : base()
        {
            this.RuleFor(item => item.PublisherId).GreaterThan(0).WithMessage("Неверное значение ИД профиля");
